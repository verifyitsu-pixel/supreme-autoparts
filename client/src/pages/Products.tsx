...
const VEHICLE_MODELS: Record<string, { name: string; img: string; year: string; type: string }[]> = {
  "Toyota": [
    { name: "Hilux (Vigo/Revo)", img: "https://images.unsplash.com/photo-1533473359331-35acde7260c9?q=80&w=800&auto=format", year: "2005–2024", type: "Pickup Truck" },
    ...
    { name: "Corolla", img: "https://images.unsplash.com/photo-1590362891991-f776e747a588?q=80&w=800&auto=format", year: "2000–2024", type: "Sedan" },
    { name: "Prado (J120/J150)", img: "https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?q=80&w=800&auto=format", year: "2002–2024", type: "SUV" },
    { name: "Vitz", img: "https://images.unsplash.com/photo-1617469767053-d3b523a0b982?q=80&w=800&auto=format", year: "2005–2020", type: "Hatchback" },
    { name: "Land Cruiser (V8/300)", img: "https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?q=80&w=800&auto=format", year: "2007–2024", type: "Full-Size SUV" },
    { name: "Harrier", img: "https://images.unsplash.com/photo-1617469767053-d3b523a0b982?q=80&w=800&auto=format", year: "2013–2024", type: "Crossover SUV" },
  ...
  "BMW": [
    ...
    { name: "5 Series (F10/G30)", img: "https://images.unsplash.com/photo-1555215695-3004980ad54e?q=80&w=800&auto=format", year: "2010–2024", type: "Sedan" },
    { name: "7 Series (F01/G11)", img: "https://images.unsplash.com/photo-1555215695-3004980ad54e?q=80&w=800&auto=format", year: "2008–2024", type: "Luxury Sedan" },
    { name: "X3 (F25/G01)", img: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?q=80&w=800&auto=format", year: "2010–2024", type: "Compact SUV" },
    ...
    { name: "X6 (F16/G06)", img: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?q=80&w=800&auto=format", year: "2014–2024", type: "Sports SAV" },
  ],
  "Mercedes-Benz": [
  ...
  "Honda": [
    ...
    { name: "CR-V", img: "https://images.unsplash.com/photo-1606152421802-db97b9c7a11b?q=80&w=800&auto=format", year: "2007–2024", type: "Compact SUV" },
    { name: "Accord", img: "https://images.unsplash.com/photo-1606152421802-db97b9c7a11b?q=80&w=800&auto=format", year: "2008–2024", type: "Sedan" },
    { name: "HR-V", img: "https://images.unsplash.com/photo-1606152421802-db97b9c7a11b?q=80&w=800&auto=format", year: "2014–2024", type: "Subcompact SUV" },
  ...
  "Ford": [
    { name: "Ranger (T6/T7/T8)", img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800&auto=format", year: "2011–2024", type: "Pickup Truck" },
  ...
  "Hyundai": [
    ...
    { name: "Elantra", img: "https://images.unsplash.com/photo-1617469767053-d3b523a0b982?q=80&w=800&auto=format", year: "2010–2024", type: "Sedan" },
