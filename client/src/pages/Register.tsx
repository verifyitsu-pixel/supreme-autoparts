...
export default function Register() {
  ...
  const handleAppleRegister = async () => {
    try {
      ...
      setLocalError(err instanceof Error ? err.message : "Apple sign-up failed");
    }
  };
      ...
      <main className="flex-1 pt-20">
        <div className="max-w-md mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black text-gray-900 mb-4">Create Account</h1>
            <p className="text-gray-600 text-sm">Join Supreme Autoparts and start shopping</p>
          </div>
