...
function seedSampleProducts() {
  if (products.size === 0) {
    const sampleProducts: Omit<StoredProduct, "id" | "createdAt" | "updatedAt">[] = [
      // TOYOTA - Hilux
      { name: "Toyota Hilux Brake Pads - Premium OEM", sku: "TOY-HLX-BRK-001", category: "Braking Systems", subcategory: "Brake Pads", brand: "Toyota", model: "Hilux (Vigo/Revo)", price: 15500, comparePrice: 18000, cost: 9000, stock: 25, lowStockThreshold: 5, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "Genuine OEM brake pads for Toyota Hilux Vigo and Revo models.", condition: "New", status: "active", tags: ["toyota", "hilux", "brake pads"], partNumber: "04465-0K230", compatibility: ["Toyota Hilux Vigo", "Toyota Hilux Revo"], sales: 45 },
      { name: "Toyota Hilux Brake Discs - Front Pair", sku: "TOY-HLX-BRK-002", category: "Braking Systems", subcategory: "Brake Discs", brand: "Toyota", model: "Hilux (Vigo/Revo)", price: 28000, comparePrice: 32000, cost: 17000, stock: 12, lowStockThreshold: 3, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "OEM brake discs for Hilux.", condition: "New", status: "active", tags: ["toyota", "hilux", "brake disc"], partNumber: "43512-0K080", compatibility: ["Toyota Hilux Vigo", "Toyota Hilux Revo"], sales: 22 },
      { name: "Toyota Hilux Oil Filter", sku: "TOY-HLX-ENG-001", category: "Engine Components", subcategory: "Oil Filters", brand: "Toyota", model: "Hilux (Vigo/Revo)", price: 3500, comparePrice: 4500, cost: 2000, stock: 50, lowStockThreshold: 10, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "Original Toyota oil filter for Hilux.", condition: "New", status: "active", tags: ["toyota", "hilux", "oil filter"], partNumber: "90915-20001", compatibility: ["Toyota Hilux Vigo", "Toyota Hilux Revo"], sales: 88 },
      
      // TOYOTA - Fielder
      { name: "Toyota Fielder Brake Pads", sku: "TOY-FLD-BRK-001", category: "Braking Systems", subcategory: "Brake Pads", brand: "Toyota", model: "Fielder", price: 12000, comparePrice: 15000, cost: 7000, stock: 30, lowStockThreshold: 8, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "OEM brake pads for Toyota Fielder.", condition: "New", status: "active", tags: ["toyota", "fielder", "brake pads"], partNumber: "04465-12F50", compatibility: ["Toyota Fielder NZE161"], sales: 42 },
      { name: "Toyota Fielder Headlight Assembly", sku: "TOY-FLD-BOD-001", category: "Body Kits & Styling", subcategory: "Headlights", brand: "Toyota", model: "Fielder", price: 22000, comparePrice: 28000, cost: 13000, stock: 12, lowStockThreshold: 3, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "Complete headlight assembly for Toyota Fielder.", condition: "New", status: "active", tags: ["toyota", "fielder", "headlight"], partNumber: "81150-12F60", compatibility: ["Toyota Fielder NZE161"], sales: 33 },
      
      // TOYOTA - Prado
      { name: "Toyota Prado J150 Shock Absorber", sku: "TOY-PRD-SUS-001", category: "Suspension & Chassis", subcategory: "Shock Absorbers", brand: "Toyota", model: "Prado (J120/J150)", price: 25000, comparePrice: 30000, cost: 15000, stock: 15, lowStockThreshold: 4, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "Heavy duty shock absorber for Prado J150.", condition: "New", status: "active", tags: ["toyota", "prado", "shock"], partNumber: "48510-60260", compatibility: ["Toyota Prado J150"], sales: 25 },
      
      // BMW - 3 Series
      { name: "BMW 3 Series Oil Filter Kit", sku: "BMW-3S-ENG-001", category: "Engine Components", subcategory: "Oil Filters", brand: "BMW", model: "3 Series (E90/F30/G20)", price: 8500, comparePrice: 10000, cost: 4500, stock: 40, lowStockThreshold: 8, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "Original BMW oil filter kit for 3 Series models.", condition: "New", status: "active", tags: ["bmw", "3 series", "oil filter"], partNumber: "11427566327", compatibility: ["BMW F30", "BMW G20"], sales: 62 },
      { name: "BMW 3 Series Brake Pads", sku: "BMW-3S-BRK-001", category: "Braking Systems", subcategory: "Brake Pads", brand: "BMW", model: "3 Series (E90/F30/G20)", price: 16000, comparePrice: 19000, cost: 9500, stock: 22, lowStockThreshold: 5, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "Premium brake pads for BMW 3 Series.", condition: "New", status: "active", tags: ["bmw", "3 series", "brake pads"], partNumber: "34116792868", compatibility: ["BMW F30", "BMW G20"], sales: 38 },
      
      // BMW - X5
      { name: "BMW X5 Front Air Spring", sku: "BMW-X5-SUS-001", category: "Suspension & Chassis", subcategory: "Struts", brand: "BMW", model: "X5 (E70/F15/G05)", price: 45000, comparePrice: 55000, cost: 28000, stock: 5, lowStockThreshold: 2, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "OEM air spring for BMW X5 suspension.", condition: "New", status: "active", tags: ["bmw", "x5", "air spring"], partNumber: "37116794447", compatibility: ["BMW X5 F15", "BMW X5 G05"], sales: 12 },
      
      // MERCEDES - C-Class
      { name: "Mercedes C-Class Brake Pads", sku: "MER-C-BRK-001", category: "Braking Systems", subcategory: "Brake Pads", brand: "Mercedes-Benz", model: "C-Class (W204/W205/W206)", price: 14000, comparePrice: 17000, cost: 8500, stock: 25, lowStockThreshold: 6, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "OEM brake pads for Mercedes C-Class.", condition: "New", status: "active", tags: ["mercedes", "c-class", "brake pads"], partNumber: "0044204320", compatibility: ["Mercedes W205"], sales: 41 },
      
      // HONDA - Civic
      { name: "Honda Civic Alternator", sku: "HON-CIV-ELC-001", category: "Electrical & Sensors", subcategory: "Alternators", brand: "Honda", model: "Civic (FD/FB/FC)", price: 28000, comparePrice: 35000, cost: 17000, stock: 6, lowStockThreshold: 2, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "High-output alternator for Honda Civic.", condition: "New", status: "active", tags: ["honda", "civic", "alternator"], partNumber: "31100-RNA-A01", compatibility: ["Honda Civic FC"], sales: 27 },
      
      // FORD - Ranger
      { name: "Ford Ranger T6 Turbocharger", sku: "FOR-RAN-ENG-001", category: "Engine Components", subcategory: "Fuel Injectors", brand: "Ford", model: "Ranger (T6/T7/T8)", price: 65000, comparePrice: 75000, cost: 40000, stock: 4, lowStockThreshold: 1, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "Genuine turbocharger for Ford Ranger 2.2/3.2.", condition: "New", status: "active", tags: ["ford", "ranger", "turbo"], partNumber: "BK3Q-6K682-RC", compatibility: ["Ford Ranger T6"], sales: 15 },
      
      // SUZUKI - Swift
      { name: "Suzuki Swift Clutch Kit", sku: "SUZ-SWF-TRN-001", category: "Transmission & Gear", subcategory: "Clutch Kits", brand: "Suzuki", model: "Swift", price: 18000, comparePrice: 22000, cost: 11000, stock: 12, lowStockThreshold: 3, images: ["https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800"], description: "Complete clutch kit for Suzuki Swift.", condition: "New", status: "active", tags: ["suzuki", "swift", "clutch"], partNumber: "22100-71L00", compatibility: ["Suzuki Swift"], sales: 22 },
      
      // LEXUS - RX350
      { name: "Lexus RX350 Air Filter", sku: "LEX-RX-ENG-001", category: "Engine Components", subcategory: "Air Filters", brand: "Lexus", model: "RX350", price: 5500, comparePrice: 7000, cost: 3000, stock: 30, lowStockThreshold: 5, images: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800"], description: "Genuine air filter for Lexus RX350.", condition: "New", status: "active", tags: ["lexus", "rx350", "air filter"], partNumber: "17801-31110", compatibility: ["Lexus RX350"], sales: 45 },
    ];
